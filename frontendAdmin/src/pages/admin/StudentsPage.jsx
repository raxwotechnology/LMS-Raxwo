...
const StudentsPage = () => {
  ...
  const handleEdit = (student) => {
    ...
    setFormData({
      ...
      password: '', // Kept empty for security; enter only if modifying
                  ...
                  <div className="form-grid">
                    <div className="form-group">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        placeholder="Enter LMS login username or email"
                      />
                    </div>

                    <div className="form-group">
                      <label htmlFor="password">
                        Password {editingStudent && <span className="auto-generated">(Leave blank to keep unchanged)</span>}
                      </label>
                      <div className="password-input-wrapper">
                        <input
                          ...
                          onChange={handleInputChange}
                          placeholder={editingStudent ? 'Enter new password to change' : 'Set student portal password'}
                        />
                        <button
                          type="button"
